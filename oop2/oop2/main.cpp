...
int main()
{
    ...
    cout << "arr10: ";
    arr10.print();
    cout << "find(10): " << arr10.findReturnIndex(10) << endl;
    cout << "find(15): " << arr10.findReturnIndex(15) << endl;
    cout << "fingMax=20: " << arr10.fingMax() << endl;
    cout << "findMin=5: " << arr10.findMin() << endl;
